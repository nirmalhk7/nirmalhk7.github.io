          ...
          <div className="row about-content">
            <div className="col-six tab-full left">
              <div className="padding-bottom:1em">
                ...
                <p>
                  I’m from India, and I’m second year student at National Institute of Technology, Karnataka.
                  Programming, reading books, reading news, table tennis and{" "}
                ...
                <p>
                  ...
                  currently study in <strong>National Institute of Technology Karnataka</strong> doing BTech in
                  Information Technology and have <em>7.06</em> CGPA<small>(as of May 2019)</small>
                </p>

                <h5 id="technical-projects-and-activities">Technical Projects and Activities</h5>
                <p>
                  My projects are listed below. Most of them are open-sourced on GitHub. I’ve worked on several MERN
                  Stack based, Native Android and Ruby on Rails projects. I’m also member Web Developer of IRIS NITK,
                  which is NITK’s student-run university management portal. I’m also passionate about Machine Learning
              ...
              <Link to="Resume.pdf" className="btn btn--primary full-width" style={{ marginTop: "1em" }}>
                Download My Resume
              </Link>
              ...
              <div className="row">
                ...
                <ul className="disc">
                  {courses.online.map((element, index) => (
                    <li key={index}>
                      {element.name} by {element.provider}- (<Link to={element.link}>link</Link>)
                    </li>
                  ))}
                </ul>
              </div>
                  ...
                  projects.map((element, index) => (
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ display: `${this.state.isOpen[index] ? "block" : "none"}` }}
                      >
