  ...
  <section id="about" className="s-about target-section">
    <div className="row narrow section-intro has-bottom-sep">
      <div className="col-full text-center">
        ...
        <h1>More About Me</h1>
        <p className="lead">
          I'm a student in National Institute of Technology Karnataka Surathkal
          doing a Bachelors in Information Technology constantly looking for new
    ...
    <div className="row about-content">
      <div className="col-six tab-full left">
        <div className="padding-bottom:1em">
          ...
          <p>
            I’m from India, and I’m second year student at National Institute of
            Technology, Karnataka. Programming, reading books, reading news,
            table tennis and{" "}
            <strong>making applications that eliminate iterative work</strong>{" "}
            is my hobby. I like to constantly challenge myself with problems. I
            also have a knack for finance and investment.
          </p>
          <h5 id="academics">Academics</h5>
          <p>
            I completed my 10th grade in Bangalore with{" "}
            <strong>9.4 CGPA</strong> and my 12th grade with 87.9%. I currently
            study in <strong>National Institute of Technology Karnataka</strong>{" "}
            doing BTech in Information Technology and have <em>7.06</em> CGPA
          ...
          <p>
            ...
            GitHub. I’ve worked on several MERN Stack based, Native Android and
            Ruby on Rails projects. I’m also member Web Developer of IRIS NITK,
            which is NITK’s student-run university management portal. I’m also
      ...
      <div className="col-six tab-full right">
        ...
        <div className="row">
          ...
          {Object.values(skills).map((type) =>
            type.map((element, index) => (
              <div key={index} className="col-two minicard">
                {element.name}
              </div>
            ))
          )}
        ...
        <div className="row">
          <h5 style={{ paddingTop: "0.5em" }}>
            Online Certification and Courses Taken
          </h5>
          <hr style={{ borderColor: "#af2b2b", margin: "10px!important" }} />
          <ul className="disc">
                    ...
                    >
                      ...
                      >
                        <div className="accordion-body__contents">
                          ...
                          <Link to="/project#Silver-Scrappie">
                            Find more here
                          </Link>
                          .&nbsp;&nbsp;&nbsp;
                          <code>
                            {element.childMarkdownRemark.frontmatter.medium}
                          </code>
                        </div>
                      </div>
                    </div>
