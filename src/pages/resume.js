  ...
  return (
    <>
      <div id="page_1">
        ...
        {Array(2).fill(1).map(e => (<><table cellpadding="0" cellspacing="0" className={styles.t2}>
          <tr>
          ...
          <tr>
            <td class={styles.tr0 + " " + styles.td4}>
              <p class={styles.p5 + " " + styles.ft1}>May 2021 - July 2021</p>
            </td>
            <td class={styles.tr0 + " " + styles.td5}>
              <p class={styles.p5 + " " + styles.ft6}>&nbsp;</p>
            </td>
          </tr>
        </table><p class={styles.p9 + " " + styles.ft1}>
            <span class={styles.ft1}>-</span>
            <span className={styles.ft5}>
              Coordinated with different Visa teams and listed out various metrics
              collected from Visa Developer Platform (VDP).
            </span>
          </p><p class={styles.p10 + " " + styles.ft1}>
            ...
            clients, developers and product developers and provide pooled VDP data
            from one single source.
          </p></>))}

        <p class={styles.p13 + " " + styles.ft1}>PROJECTS</p>
        {Array(5).fill(1).map(e => (<><table cellpadding="0" cellspacing="0" class={styles.t4}>
          <tr>
        ...
        </table><p class={styles.p14 + " " + styles.ft1}>
            Developed an Android app aimed to facilitate a college going student:
            complete with CRUD function- alities for exams, holidays and daily
            timetable.
          </p></>))}
      </div>
    </>
