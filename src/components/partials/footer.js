            ...
            <div className="row footer-bottom">
                <div className="col-twelve">
                    <div className="copyright">
                        <span style={{color:"#3d3d3d"}}>Made with <i className="im im-heart heartbeat" style={{fontSize: "14px"}}></i> by Nirmal Khedkar</span>
                        <span style={{color:"#3d3d3d"}}>Last Updated: July 20, 2020</span>
                    </div>
                    <div className="copyright">
                        <span style={{color: "#1d1d1d"}} id="justinmaller">Image Credits <a className="hidelink" href="/" style={{color: "#1d1d1d"}}>Beast Dreams II</a> by Justin Maller</span>
                        <span style={{color: "#1d1d1d"}}>Theme by <a className="hidelink" href="https://www.styleshout.com/" style={{color: "#1d1d1d"}}>styleshout</a> (Copyright Hola 2017)</span>
                    </div>
