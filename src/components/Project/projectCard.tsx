...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  const CardContent = (
    <div className="relative overflow-hidden bg-white/60 backdrop-blur-md border border-white/20 p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full no-underline">
      <m.div
        aria-hidden="true"
  ...
  return (
    ...
    >
      <TiltCard
        className="flex flex-col h-full group transition-all duration-300 cursor-pointer"
      >
        <Link
          href={href}
          prefetch={false}
