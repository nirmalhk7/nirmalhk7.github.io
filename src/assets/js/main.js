...
(function($) {
    ...
    var ssSlickSlider = function() {
        ...
        $('.testimonials__slider').slick({
            ...
            slidesToShow: 2,
            slidesToScroll: 1,
            prevArrow: "<div className=\'slick-prev\'><i className=\'im im-arrow-left\' aria-hidden=\'true\'></i></div>",
            nextArrow: "<div className=\'slick-next\'><i className=\'im im-arrow-right\' aria-hidden=\'true\'></i></div>",       
            pauseOnFocus: false,
            autoplaySpeed: 1500,
            responsive: [
                {
